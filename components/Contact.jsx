        ...
        <div className='grid lg:grid-cols-5 gap-8'>
          ...
          <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
            <div className='lg:p-4 h-full '>
              ...
              <div>
                <h2 className='py-2 px-20'>Tooba Yousaf</h2>
                <p className='font-semibold px-28'>Full Stack Developer</p>
                <p className='py-4 font-medium'>
                  I am available for full-time positions, freelance, part-time or remote jobs. Contact
                  me and let&apos;s talk.
                </p>
              </div>
              <div>
                <p className='uppercase pt-5 px-28 font-semibold'>Connect With Me</p>
